...
def check():
    file = '/mnt/F/Scripts/VLC/next.txt'
    f = open(file, 'r')
    temp = f.readline()
...
def Next():
    ...
    Mpath = '/mnt/E/Series/'
    configfile = '/mnt/F/Scripts/VLC/Config.txt'
    ...
    Series = search_for_series(SeriesName, Mpath)
    ...
    test = '--pidfile /mnt/F/Scripts/VLC/test.txt'
